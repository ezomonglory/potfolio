...
const HomepageMain = () => {
	...
	return (
		<div className='flex flex-col gap-0 justify-center items-center overflow-x-hidden   center'>
			<div className='flex gap-[8px] items-center mb-[8px] md:mb-0'>
				...
				/>
				<p className='text-[18px] md:text-[24px] leading-[22px] md:leading-[40px] tracking-[0.5px] md:tracking-[1px] text-[#252C35]  '>
					Hey guys, Ezomon Glory here
				</p>
			</div>

			<div className='text-[50px] sm:text-[64px]  sm:leading-[70px] lg:text-[76px] xl:text-[124px] lg:leading-[80px]  tracking-[-2.5px] md:tracking-[-4.5px] font-front-end text-[#111821]  xl:leading-[120px] block text-center leading-[50px] mb-4 '>
...
<div className='relative overflow-x-hidden w-full  flex flex-col justify-center items-center'>
            ...
            <a
                href='#'
                className='flex gap-[4px]  rounded-full  items-center justify-center  absolute top-0  cursor-pointer mx-auto bg-[#DE3F3B] rounded-full px-8 py-2 lg:px-[22px] lg:py-[8px] text-white'
            >
